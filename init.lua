...
for i=1, 7 do
	...
	elseif i < 5 then
		...
		texture1 = "mcl_small_3d_plants_carrot_2.png"
	else
		sel_height1 = -0.3125
		texture = "farming_carrot_3.png"
		texture1 = "mcl_small_3d_plants_carrot_3.png"
	end
...
for b=1, 7 do
    local texture, selbox
	  if b < 2 then
		...
		texture1 = "mcl_small_3d_plants_wheat_stage_1.png"
	...
	w25y2 = -0.4375
	  ...
	  elseif b == 2 then
		...
		texture1 = "mcl_small_3d_plants_wheat_stage_2.png"
	...
	w25y2 = -0.375
	  ...
	  elseif b == 3 then
		...
		texture1 = "mcl_small_3d_plants_wheat_stage_3.png"
	...
	w25y2 = -0.25
	  ...
	  elseif b == 4 then
		...
		texture1 = "mcl_small_3d_plants_wheat_stage_4.png"
	...
	w25y2 = -0.125
	  ...
	  elseif b == 5 then
		...
		texture1 = "mcl_small_3d_plants_wheat_stage_5.png"
	...
	w25y2 = 0
	  ...
	  elseif b == 6 then
		...
		texture1 = "mcl_small_3d_plants_wheat_stage_6.png"
...
minetest.register_node(":mcl_flowers:poppy", {
	description = ("Poppy"),
	drawtype = "nodebox",
	tiles = {"mcl_small_3d_plants_poppy_top.png",
...
minetest.register_node(":mcl_nether:nether_wart_1", {
	...
	node_box = {
		...
		fixed = {
			...
			{0.3125, -0.0625, 0.1875, 0.4375, 0.0625, 0.3125},
			{0.3125, -0.0625, -0.3125, 0.4375, 0.0625, -0.1875},
			{-0.4375, -0.0625, -0.3125, -0.3125, 0.0625, -0.1875},
			{-0.4375, -0.0625, 0.1875, -0.3125, 0.0625, 0.3125},
